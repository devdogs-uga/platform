...
const authorizationCode = z.intersection(state, z.object({ code: z.string() }));

const linkUser = z.intersection(state, z.object({ linkUserId: z.string() }));
...
export const searchParamsSchema = z
  ...
  .pipe(
    z.union([authorizationCode, linkUser, beginOAuthFlow, completeOAuthFlow]),
  );
